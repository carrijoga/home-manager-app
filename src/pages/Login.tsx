...
function Login() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-muted/40 p-3 sm:p-4 lg:px-8 lg:py-4 xl:py-6 antialiased selection:bg-primary/20">
      {/* Main Split-Screen Container Card */}
      <div className="grid min-h-0 w-full max-w-5xl overflow-hidden rounded-3xl border border-border/70 bg-card shadow-2xl lg:grid-cols-12 max-h-[min(640px,calc(100dvh-2rem))]">
        ...
        <div className="flex flex-col justify-between bg-card p-6 sm:p-8 lg:col-span-6 lg:px-10 lg:py-6 xl:py-8">
          <div className="mx-auto my-auto w-full max-w-sm">
            ...
            <Button
              ...
              className="mb-3.5 h-10 w-full border-border bg-background text-sm font-medium text-foreground transition-colors hover:bg-muted active:scale-[0.99]"
            >
              {isGoogleLoading ? (
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-10 border-border bg-background pl-9 pr-3 text-sm text-foreground focus:ring-1 focus:ring-primary"
                  />
                </div>
            ...
            {import.meta.env.DEV && (
              <div className="mt-4 border-t border-border/50 pt-2 text-center">
                <button
                  type="button"
      ...
      <Dialog open={isRecoveryOpen} onOpenChange={setIsRecoveryOpen}>
        <DialogContent hideBuiltinClose className="sm:max-w-md rounded-2xl border border-border/60 p-4 sm:p-5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-9 pl-9 text-xs bg-muted/30 border-border/40 rounded-xl"
                    required
                  />
                </div>
