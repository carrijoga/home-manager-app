  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="group relative flex cursor-pointer flex-col justify-between rounded-3xl border border-border/80 bg-card p-5 shadow-xs transition-all hover:border-primary/40 hover:shadow-md active:scale-[0.99]"
      >
        <div className="flex flex-col gap-3">
          {/* Header do Card */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="flex size-9 items-center justify-center rounded-2xl bg-primary/15 text-primary transition-transform group-hover:scale-110">
          ...
          <div className="flex flex-col gap-1">
            <span className="font-ui text-2xl font-extrabold tracking-tight text-foreground sm:text-3xl">
              {formatCurrency(financial.totalMonthSpent)}
            </span>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-dashed border-border/70 pt-3 text-[11px] text-muted-foreground">
          <span>Anterior: {formatCurrency(financial.totalLastMonthSpent)}</span>
      ...
      <motion.div
        ...
        className="group relative flex cursor-pointer flex-col justify-between rounded-3xl border border-border/80 bg-card p-5 shadow-xs transition-all hover:border-chart-2/40 hover:shadow-md active:scale-[0.99]"
      >
        <div className="flex flex-col gap-3">
          {/* Header do Card */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="flex size-9 items-center justify-center rounded-2xl bg-chart-2/15 text-chart-2 transition-transform group-hover:scale-110">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1 pt-1">
              <div className="flex items-center justify-between text-[11px]">
                ...
                <span className="font-bold text-chart-2">{tasks.rateTasks}%</span>
              </div>
              <div className="h-1.5 w-full overflow-hidden rounded-full bg-muted">
                <div
                  className="h-full rounded-full bg-chart-2 transition-all duration-500"
                  style={{ width: `${tasks.rateTasks}%` }}
                />
              </div>
            </div>
          </div>
        ...
        {/* Rodapé informativo */}
        <div className="mt-4 flex items-center justify-between border-t border-dashed border-border/70 pt-3 text-[11px] text-muted-foreground">
          <span>{tasks.totalDayFinishedTasks} concluídas hoje</span>
      ...
      <motion.div
        ...
        className="group relative flex cursor-pointer flex-col justify-between rounded-3xl border border-border/80 bg-card p-5 shadow-xs transition-all hover:border-secondary/40 hover:shadow-md active:scale-[0.99]"
      >
        <div className="flex flex-col gap-3">
          {/* Header do Card */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="flex size-9 items-center justify-center rounded-2xl bg-secondary/15 text-secondary transition-transform group-hover:scale-110">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1.5 pt-0.5 text-[11px] text-muted-foreground">
              ...
              <span className="font-bold text-foreground">
                {formatCurrency(shopping.totalMonthEstimatedValue)}
              </span>
            </div>
          </div>
        </div>
      ...
      <motion.div
        ...
        className="group relative flex cursor-pointer flex-col justify-between rounded-3xl border border-border/80 bg-card p-5 shadow-xs transition-all hover:border-chart-5/40 hover:shadow-md active:scale-[0.99]"
      >
        <div className="flex flex-col gap-3">
          {/* Header do Card */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="flex size-9 items-center justify-center rounded-2xl bg-chart-5/15 text-chart-5 transition-transform group-hover:scale-110">
              ...
              <div>
                ...
                <h4 className="font-editorial text-sm font-bold text-foreground">Agenda do Ninho</h4>
              </div>
            </div>
