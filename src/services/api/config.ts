...
export const ENVIRONMENT = (import.meta.env.VITE_ENVIRONMENT as string | undefined) || 'development';
...
export const API_BASE_URL = (import.meta.env.VITE_API_URL as string | undefined) || 'http://localhost:5026';
